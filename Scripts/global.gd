...
var currentRule = 1
#Rule 1: Must collect all the collectibles to open the door. good sound when collectible collected
#Rule 2: Must turn on all the levers to open the door. good sound when turned on, bad soun when turned off
